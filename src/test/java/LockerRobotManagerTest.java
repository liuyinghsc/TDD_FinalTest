...
//        final LockerRobotManager lockerRobotManager = new LockerRobotManager(List.of(firstLocker, new Locker(2)), List.of(null));
//
...
//        final LockerRobotManager lockerRobotManager = new LockerRobotManager(List.of(null), List.of(firstRobot, secondRobot));
//
//        final Bag bag = new Bag();
