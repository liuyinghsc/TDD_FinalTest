...
public class LockerSystemFinalTest {
    ...
    @Test(expected = LockerHasNoRoomException.class)
    public void should_save_failed_when_vip_user_save_m_bag_given_VipManager_has_no_room() {
        Locker vipsLocker = new Locker(5, "S");
        Locker vipmLocker = new Locker(5, "M");
        vipmLocker.save(new Bag("M"));
        vipmLocker.save(new Bag("M"));
        vipmLocker.save(new Bag("M"));
        vipmLocker.save(new Bag("M"));
        vipmLocker.save(new Bag("M"));
    ...
    public void should_failed_pickup_bag_when_normal_user_pickup_bag_given_invalid_ticket_normalManager_manage_one_locker_and_one_priRobot_and_one_superRobot() {
        Locker vipsLocker = new Locker(5, "S");
        Locker vipmLocker1 = new Locker(5, "M");
        PrimaryLockerRobot vipPriRobot = new PrimaryLockerRobot(vipmLocker1);
        Locker viplLocker1 = new Locker(5, "L");
        SuperLockerRobot vipSuperRobot = new SuperLockerRobot(viplLocker1);
        VipLockerRobotManager vipLockerRobotManager = new VipLockerRobotManager(List.of(vipsLocker), List.of(vipPriRobot), List.of(vipSuperRobot));
    ...
    @Test(expected = InvalidTicketException.class)
    public void should_failed_pickup_bag_when_normal_user_pickup_bag_given_not_match_invalid_ticket_normalManager_manage_one_locker_and_one_priRobot_and_one_superRobot() {
        Locker sLocker = new Locker(5, "S");
        Locker mLocker1 = new Locker(5, "M");
        PrimaryLockerRobot priRobot = new PrimaryLockerRobot(mLocker1);
        Locker lLocker = new Locker(5, "L");
        ...
        Ticket ticket = normalManager.save(new Bag("L"));
        priRobot.pickUp(ticket);
