...
//    public void should_throw_exception_when_pick_up_bag_given_invalid_ticket() {
//        Ticket ticket = new Locker(1).save(new Bag());
//        PrimaryLockerRobot primaryLockerRobot = new PrimaryLockerRobot(new Locker(1), new Locker(1));
//
